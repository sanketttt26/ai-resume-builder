...
const FormSection = () => {
  ...
  return (
    <div>
     ...
     {/* personal details */}
     {activeFormIndex==1?<PersonalDetailForm enableNext={(val)=>setEnableNext(val)}/>

     :activeFormIndex==2?<SummeryForm enableNext={(val)=>setEnableNext(val)} />
     :activeFormIndex==3?<ExperienceForm enableNext={(val)=>setEnableNext(val)} />
     :null}
    </div>
  )
}
